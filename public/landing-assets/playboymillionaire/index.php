...
<head>
        ...
        <title>LEARN HOW YOU CAN MAKE A FORTUNE MY WAY</title>
    </head>
    <body class="bg_red">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="form_holder">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 nogutter">
                                <input type="submit" class="btn btn-primary btn-block" value="SUBMIT" id="submitFormButton">
                            </div> -->
                        <form id="target" method="get" accept-charset="UTF-8" action="register.php">
