...
<head>
    ...
    <link href="css/intlTelInput.css" type="text/css" rel="stylesheet">
        <link href="../../../../cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.css" rel="stylesheet" type="text/css">
        <link href="../../../../options.magnumoptions.com/regform/assets/css/form_style_en.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="../../../../ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
        <script src="js/bootstrap.min.js"></script>
        <script src="http://options.magnumoptions.eu/rclp/plugin"></script>
        <title>CONGRATULATIONS AND WELCOME TO THE VIP AREA!</title>
        <style>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 nonogutter">
                        <div class="movie">
                            <div class="wistia_responsive_padding" style="padding:56.25% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"><iframe src="https://fast.wistia.net/embed/iframe/d9dpvfabtk?videoFoam=true" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="100%" height="100%"></iframe></div></div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 nonogutter">
                        <div class="form-bg">
                            ...
                            <p class="sub-little">
                                Register your <span class="red">free account</span> here
                            </p>
                            <div class="form">
                                <div class="row">
    <div class="formholder form-group" >
      <div class="form-holder form-group" >
          <form id="target"   method="post" action="">
              <input type="hidden" name="id" value=""/>
              <input type="hidden" id="afp" name="afp" value=""/>
              <input type="hidden" id="utm_campaign" name="utm_campaign" value=""/>
              <input type="hidden" id="tid" name="tid" value=""/>
              <input type="hidden" id="utm_subcampaign" name="utm_subcampaign" value=""/>
              ...
              <input type="hidden" id="cmp" name="cmp" value=""/>
              <input type="hidden" id="kws" name="kws" value=""/>
              <input type="hidden" id="pls" name="pls" value=""/>
              <input type="hidden" id="inf" name="inf" value=""/>
              <input type="hidden" id="dvc" name="dvc" value=""/>
              <input type="hidden" id="crt" name="crt" value=""/>
              <input type="hidden" id="trg" name="trg" value=""/>
              <input type="hidden" id="actual_url" name="actual_url" value=""/>
              <input type="hidden" name="landing" id="landing" value=""/>
              <input type="hidden" id="industry" name="industry" value="both"/>
              <input type="hidden" name="phonev" id="phonev" class="form_input" value="">
              <input type="hidden" name="code" id="code" class="form_input" value="">
              <input type="hidden" name="country_num" id="country_num" value=''/>
          <input type="hidden" name="lang"  value='en'/>
          <input type="hidden" name="page_name"  value='playboymillionaire'/>

                            <div class="row">
                              <div class="col-xs-12">
                                <div class="form-group">
                                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input type="text" name="first_name" id="first_name" class="form_input form-control" placeholder="First Name" value="<?php if(isset($_GET['first_name'])): ?><?= htmlentities($_GET['first_name'])?><?php else: ?> <?php endif; ?>">
                                    </div>
                                  </div>
                                </div>
                            </div>
                              ...
                              <div class="col-xs-12">
                                <div class="form-group">
                                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                    <input type="text" name="last_name" id="last_name" class="form_input form-control" placeholder="Last Name" value="<?php if(isset($_GET['last_name'])): ?><?= htmlentities($_GET['last_name'])?><?php else: ?> <?php endif; ?>">
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="form-group">
                                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                    <input type="text" name="email" id="email" class="form_input email form-control" placeholder="email" value="<?php if(isset($_GET['email'])): ?><?= htmlentities($_GET['email'])?><?php else: ?> <?php endif; ?>">
                                  </div>
                                </div>
                              </div>
                            </div>
                                      ...
                                      <div class="col-xs-12">
                                        <div class="form-group">
                                          <div class="input-group  "> <span class="input-group-addon"><i class="fa fa-phone-square"></i></span>
                                             <select name="country" id="country" class="globe-icon gry-input form_input form-control"></select>
                                        ...
                                        <div class="col-xs-12" >
                                          <div class="form-group">
                                            ...
                                            <input type="text" name="phone" id="phone" class="form_input phone form-control"  placeholder="Phone">
                                          </div>
                                        </div>
                                      </div>
                                  </div>
                          ...
                          <div class="row">
                              <div class="col-xs-12">
                                  <input type="submit" value="submit" class="btn btn-primary btn-lg btn-block submit">
                              </div>
                          </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="img-trust">
                            <img src="images/trust.png" class="img-responsive">
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="AntiSpamModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        ...
        <script>
            ...
            $('#target').on('submit', function () {
                ...
                if (phonev == "no") {
                    ...
                    var error = "Please insert valid phone number";
                    $("#myerrors").html(error);
                    $("#phone").css({"background": "rgb(255, 210, 210)", "color": "#000000 "});
        ...
        <script>
            ...
            $('#tel_1').on('keydown', function () {
                var prefix = $('.intl-tel-input.separate-dial-code .selected-dial-code').text();
                var phone = $(this).val();
                var fullphone = $('#fullphone').val(prefix + phone);
            });
        </script>
    </body>
</html>
