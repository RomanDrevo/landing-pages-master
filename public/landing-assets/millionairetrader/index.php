...
<html>
<head>
        <title>LEARN HOW YOU CAN MAKE A FORTUNE WITH ONE OF THE BEST KEPT SECRETS</title>
        <meta charset="utf-8">
        <meta charset="utf-8">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 nopadding" >
                  <div class="textContent">
                      ...
                      <div class="row boxheight ">
                        ...
                        <form id="target"   method="get" accept-charset="UTF-8" action="index1750.php">
                        ...
                        <div class="row filling">
                          <div class="col-lg-12">
                              <input type="text" class="form-control textbox" id="first_name" name="first_name" placeholder="First Name" required>
                              <input type="text" class="form-control textbox" id="last_name" name="last_name" placeholder="Last Name" required>
                          </div>
                          <div class="col-lg-12 ">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center logos">
                    <img src="images/logo-1.png" width="76" height="76" alt="Top Profit System 2016 Logo"/>
                    <img src="images/logo-2.png" width="76" height="76" alt="Trade Trust logo"/>
                    <img src="images/logo-3.png" width="76" height="76" alt="VIP Logo"/>
                    <img src="images/logo-4.png" width="76" height="76" alt="SSL Logo"/>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
